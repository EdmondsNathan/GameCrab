...
impl Console {
    pub(super) fn srl(&mut self, bit_args: BitArgs) -> Option<u64> {
...
mod tests {
    ...
    fn to_register8() {
        ...
        assert_eq!(console.cpu.get_register(&Register8::B), 0b00100000);
        ...
        assert_eq!(console.cpu.get_register(&Register8::D), 0b01000001);
    ...
    fn to_hl() {
        ...
        assert_eq!(console.ram.fetch(0x200), 0b01000001);
        assert_eq!(console.cpu.get_register(&Register8::F), 0b00010000);

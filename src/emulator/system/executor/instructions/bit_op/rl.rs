...
impl Console {
    pub(super) fn rl(&mut self, bit_args: BitArgs) -> Option<u64> {
...
mod tests {
    ...
    fn to_register8() {
        ...
        assert_eq!(console.cpu.get_register(&Register8::D), 0b10000001);
    ...
    fn to_hl() {
        ...
        assert_eq!(console.ram.fetch(0x202), 0b00001001);
        assert_eq!(console.cpu.get_register(&Register8::F), 0b00000000);
    }
}

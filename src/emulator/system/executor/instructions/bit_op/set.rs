...
impl Console {
    pub(super) fn set(&mut self, bit_args: BitArgs) -> Option<u64> {
        fn to_hl(console: &mut Console) -> Option<u64> {
            ...
            console.push_command(
                ...
                Update(|console: &mut Console| {
                    ...
                    let result = mask(ram_value, shift);

                    console
                        .ram
                        .set(result, console.cpu.get_register_16(&Register16::Hl));
                }),
            );
...
mod tests {
    ...
    fn to_register8() {
        ...
        console.cpu.set_register(0b10000000, &Register8::B);
        console.cpu.set_register(0b10000000, &Register8::C);
        console.cpu.set_register(0b10000000, &Register8::D);
        console.cpu.set_register(0b10000000, &Register8::E);
        ...
        assert_eq!(console.cpu.get_register(&Register8::B), 0b10000001);
        ...
        assert_eq!(console.cpu.get_register(&Register8::C), 0b10000010);
        ...
        assert_eq!(console.cpu.get_register(&Register8::D), 0b10000100);
        ...
        assert_eq!(console.cpu.get_register(&Register8::E), 0b10001000);
    }
    ...
    fn to_hl() {
        ...
        assert_eq!(console.ram.fetch(0x201), 0b10000010);

        console.cpu.set_register_16(0x202, &Register16::Hl);
        for n in 0..16 {
            console.tick();
        }
        assert_eq!(console.ram.fetch(0x202), 0b10000100);
    }
}

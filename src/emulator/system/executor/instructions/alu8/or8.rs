...
impl Console {
    pub(super) fn or8(&mut self, arg: A8Args) -> Option<u64> {
        match arg {
            A8Args::HL => {
                self.push_command(
                    3,
...
mod tests {
    ...
    #[test]
    fn or8_hl() {
        let mut console = init(vec![(0xB6, 0x100), (0b10001011, 0x200)]);
        ...
        assert_eq!(console.cpu.get_register(&Register8::A), 0b11001011);
    }

    #[test]
    fn or8_u8() {
        let mut console = init(vec![(0xF6, 0x100), (0b10001011, 0x101)]);
        console.cpu.set_register(0b11000001, &Register8::A);
    ...
    #[test]
    fn or8_register8() {
        let mut console = init(vec![(0xB0, 0x100)]);
        console.cpu.set_register(0b11000001, &Register8::A);

...
impl Console {
    pub(super) fn and8(&mut self, arg: A8Args) -> Option<u64> {
        match arg {
            A8Args::HL => {
                self.push_command(
                    3,
...
mod tests {
    ...
    #[test]
    fn and8_hl() {
        let mut console = init(vec![(0xA6, 0x100), (0b10001011, 0x200)]);
    ...
    #[test]
    fn and8_u8() {
        let mut console = init(vec![(0xE6, 0x100), (0b10001011, 0x101)]);
        console.cpu.set_register(0b11000001, &Register8::A);
    ...
    #[test]
    fn and8_register8() {
        let mut console = init(vec![(0xA0, 0x100)]);
        console.cpu.set_register(0b11000001, &Register8::A);
